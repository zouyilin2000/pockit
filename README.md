...
**😃 Welcome to the pockit project page.**
...
Install the optional Ipopt and plotting dependencies:

```console
pip install "pockit-optimal-control[ipopt,examples]"
```
...
guess_s = [0.0]  # initial guess for the free parameter x_f
...
![Result of the LQR Problem](https://raw.githubusercontent.com/zouyilin2000/pockit/main/images/lqr_readme.png)
