...
The authoritative recipe will live in `conda-forge/pockit-feedstock` only after the
initial `conda-forge/staged-recipes` pull request is accepted.
...
`conda-forge/pockit-feedstock` 仓库维护。
